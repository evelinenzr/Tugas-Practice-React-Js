...
export default function Card({product}) {
  return (
    <Link to={`/products/${product.slug}` ?? ''} className="flex flex-col max-w-[370px] flex-wrap p-[16px] bg-[#F8E8EE] hover:ring-opacity-40 active:ring-5 active:ring-[#9B7EBD] hover:ring-4 active:ring-2 active:ring-opacity-90" >
    <div className="flex flex-col max-w-[370px] flex-wrap p-[16px] bg-[#F8E8EE]" >
                ...
                {product.stock <= 0 ? (
                    ...
                    <>
                       <p className="text-xl font-semibold text-center text-yellow-500">Almost Sold Out</p>
                        <Button type="button" className="inline-flex items-center justify-center gap-2 p-4 bg-[#D23369] text-center hover:bg-[#F06292] text-white active:bg-[#FFEFEF]">
